...
func (x *WhirlyMsg) GetPayload() isWhirlyMsg_Payload {
	if x != nil {
		return x.Payload
	}
	return nil
...
func (x *WhirlyMsg) GetWhirlyProposal() *WhirlyProposal {
	if x != nil {
		if x, ok := x.Payload.(*WhirlyMsg_WhirlyProposal); ok {
...
func (x *WhirlyMsg) GetWhirlyVote() *WhirlyVote {
	if x != nil {
		if x, ok := x.Payload.(*WhirlyMsg_WhirlyVote); ok {
			return x.WhirlyVote
		}
	}
	return nil
...
func (x *WhirlyMsg) GetWhirlyNewView() *WhirlyNewView {
	if x != nil {
		if x, ok := x.Payload.(*WhirlyMsg_WhirlyNewView); ok {
...
func (x *WhirlyMsg) GetRequest() *Request {
	if x != nil {
		if x, ok := x.Payload.(*WhirlyMsg_Request); ok {
			return x.Request
		}
	}
	return nil
...
func (x *WhirlyMsg) GetReply() *Reply {
	if x != nil {
		if x, ok := x.Payload.(*WhirlyMsg_Reply); ok {
			return x.Reply
		}
	}
	return nil
...
func (x *WhirlyMsg) GetNewLeaderNotify() *NewLeaderNotify {
	if x != nil {
		if x, ok := x.Payload.(*WhirlyMsg_NewLeaderNotify); ok {
...
func (x *WhirlyMsg) GetNewLeaderEcho() *NewLeaderEcho {
	if x != nil {
		if x, ok := x.Payload.(*WhirlyMsg_NewLeaderEcho); ok {
...
func (x *WhirlyMsg) GetWhirlyPing() *WhirlyPing {
	if x != nil {
		if x, ok := x.Payload.(*WhirlyMsg_WhirlyPing); ok {
			return x.WhirlyPing
		}
	}
	return nil
...
func (x *WhirlyMsg) GetLatestBlockRequest() *LatestBlockRequest {
	if x != nil {
		if x, ok := x.Payload.(*WhirlyMsg_LatestBlockRequest); ok {
...
func (x *WhirlyMsg) GetLatestBlockEcho() *LatestBlockEcho {
	if x != nil {
		if x, ok := x.Payload.(*WhirlyMsg_LatestBlockEcho); ok {
...
func (x *WhirlyMsg) GetCrWhirlyProposal() *CrWhirlyProposal {
	if x != nil {
		if x, ok := x.Payload.(*WhirlyMsg_CrWhirlyProposal); ok {
...
func (x *WhirlyMsg) GetCrWhirlyVote() *CrWhirlyVote {
	if x != nil {
		if x, ok := x.Payload.(*WhirlyMsg_CrWhirlyVote); ok {
