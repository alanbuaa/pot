...
var file_pb_hotstuff_proto_goTypes = []any{
	(*Msg)(nil),           // 0: pb.Msg
...
func file_pb_hotstuff_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_pb_hotstuff_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Msg); i {
			case 0:
				return &v.state
			case 1:
		...
		file_pb_hotstuff_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_pb_hotstuff_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_pb_hotstuff_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_pb_hotstuff_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_pb_hotstuff_proto_msgTypes[5].Exporter = func(v any, i int) any {
			switch v := v.(*Commit); i {
			case 0:
				return &v.state
			case 1:
		...
		file_pb_hotstuff_proto_msgTypes[6].Exporter = func(v any, i int) any {
		...
		file_pb_hotstuff_proto_msgTypes[7].Exporter = func(v any, i int) any {
			switch v := v.(*Decide); i {
			case 0:
				return &v.state
			case 1:
		...
		file_pb_hotstuff_proto_msgTypes[8].Exporter = func(v any, i int) any {
	...
	file_pb_hotstuff_proto_msgTypes[0].OneofWrappers = []any{
		(*Msg_Prepare)(nil),
		(*Msg_PrepareVote)(nil),
		(*Msg_PreCommit)(nil),
