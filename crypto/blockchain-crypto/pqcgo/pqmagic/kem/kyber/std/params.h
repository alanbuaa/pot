...
#if   (KYBER_K == 2)
#define KYBER_MODE 512
#define KYBER_NAMESPACE(s) pqmagic_kyber512_std##s
#elif (KYBER_K == 3)
#define KYBER_MODE 768
#define KYBER_NAMESPACE(s) pqmagic_kyber768_std##s
#elif (KYBER_K == 4)
#define KYBER_MODE 1024
#define KYBER_NAMESPACE(s) pqmagic_kyber1024_std##s
#else
