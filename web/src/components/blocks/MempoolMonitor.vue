      ...
      <div class="space-y-4">
        ...
        <div>
          ...
          <div class="relative h-6 bg-gray-700 rounded-full overflow-hidden">
            ...
            >
              <span v-if="markedPercent > 10" class="text-xs text-white font-semibold">
                {{ status?.markedTxs || 0 }}
              </span>
            </div>
            <!-- 待提议部分 (黄色) -->
            <div 
              ...
              :style="{ left: markedPercent + '%', width: unmarkedPercent + '%' }"
            >
              <span v-if="unmarkedPercent > 10" class="text-xs text-white font-semibold">
        ...
        <div>
          ...
          <div class="flex items-center gap-3">
            ...
            <div class="flex-1 flex flex-col justify-center space-y-1 text-sm">
              <div class="flex items-center gap-2">
                <div class="w-2.5 h-2.5 rounded" style="background-color: #4a9eff;"></div>
                <span>普通交易</span>
              </div>
              <div class="flex items-center gap-2">
                <div class="w-2.5 h-2.5 rounded" style="background-color: #ffd700;"></div>
                <span>BCI交易</span>
              </div>
              <div class="flex items-center gap-2">
                <div class="w-2.5 h-2.5 rounded" style="background-color: #ff4444;"></div>
                <span>Devastate</span>
              </div>
            </div>
          </div>
